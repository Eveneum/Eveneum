...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "Creating snapshot for non-existing event", "\tCreating a snapshot for a events version that is higher than stream version fail" +
                    "s with OptimisticConcurrency exception", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void CreatingSnapshotForNon_ExistentEvent()
        {
            string[] tagsOfScenario = new string[] {
                    "ExpectException"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Creating snapshot for non-existent event", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 5
